        ...
        for i = 1:size(positions, 1)
            ...
            elseif r1 <= exploitRatio
                ...
                elseif r2 <= 2/3
                    ...
                    newPosition = positions(i, :) + lr * (historyBestPositions(randIdx(3), :) - positions(i, :)) + alpha * ((2 * rand - 1) * (ub - lb) .* rand(1, dim)) + beta * (randPosition1 - randPosition2);
                end
                ...
                elseif r2 <= 2/3
                    ...
                    newPosition = lr * positions(i, :) + alpha * (randPosition1 - randPosition2) + beta * (2 * rand - 1) * historyBestPositions(randIdx(3), :) + r3 * mean(positions);
                end
            ...
            positions(i, :) = positions(i, :) + (1 - fe / maxFes) * cos(r4) .* dp;
